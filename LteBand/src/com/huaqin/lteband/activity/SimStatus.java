...
//import com.mediatek.sim.UnLockSubDialog;
import com.huaqin.lteband.util.ISettingsMiscExt;
import com.huaqin.lteband.util.LogUtils;
import com.huaqin.lteband.util.SimHotSwapHandler;
...
public class SimStatus extends PreferenceActivity {
	...
	private static final String KEY_CELL_INFO = "cell_info";
    ...
    private final void updateLocation(CellLocation location) {
        ...
        setSummaryText(KEY_CELL_INFO,radioInfo);
    }
    ...
    private void customizeTitle() {
        ...
        if (title.equals(getString(R.string.sim_status_title))) {
            ISettingsMiscExt ext = Utils.getMiscPlugin(this);
